...
function Strategy(options, verify) {
  ...
  this.options = xtend({}, options, {
    authorizationURL: 'https://accounts.dowjones.com/authorize',
    tokenURL:         'https://accounts.dowjones.com/oauth/token',
    userInfoURL:      'https://accounts.dowjones.com/userinfo',
    apiUrl:           'https://accounts.dowjones.com/api',
    delegationUrl:    'https://accounts.dowjones.com/delegation'
  });
